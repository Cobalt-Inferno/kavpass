...
void safe_return_ran(int line, Password *pass) {
    if (line >=6) {
        ...
        switch(line) {
            case 1:
                pass->tmp_c = pass->symb[pull_rand() % strlen(pass->symb)];
                break;
            case 2:
                pass->tmp_c = pass->l_let[pull_rand() % strlen(pass->l_let)];
                break;
            case 3:
                pass->tmp_c = pass->u_let[pull_rand() % strlen(pass->u_let)];
                break;
            case 4:
                pass->tmp_c = pass->ints[pull_rand() % strlen(pass->ints)];
                break;
            case 5:
                pass->tmp_c = pass->test_symb[pull_rand() % strlen(pass->test_symb)];
                break;
            default:
                pass->failed = true;
                break;
...
void safe_set_pass(Password *pass) {
    LOOP:
    if (pass->prefix) {
        for(size_t i = 0; i < pass->len + strlen(pass->pref); i++) {
...
void unsafe_return_ran(int line, Password *pass) {
    if (line >=6) {
        ...
        switch(line) {
            case 1:
                pass->tmp_c = pass->symb[rand() % strlen(pass->symb)];
                break;
            case 2:
                pass->tmp_c = pass->l_let[rand() % strlen(pass->l_let)];
                break;
            case 3:
                pass->tmp_c = pass->u_let[rand() % strlen(pass->u_let)];
                break;
            case 4:
                pass->tmp_c = pass->ints[rand() % strlen(pass->ints)];
                break;
            case 5:
                pass->tmp_c = pass->test_symb[rand() % strlen(pass->test_symb)];
                break;
            default:
                pass->failed = true;
                break;
